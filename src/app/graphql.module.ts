...
const httpUri = 'http://localhost:4000/graphql';//https://hi-chat-backend.tk/graphql'; //https://aspiring-thing.us-west-2.aws.cloud.dgraph.io/graphql';//'http://localhost:8080/graphql';
const wsUri = 'ws://localhost:4000/graphql';//'wss://hi-chat-backend.tk/graphql'; // 'wss://aspiring-thing.us-west-2.aws.cloud.dgraph.io/graphql';//'ws://localhost:8080/graphql';
